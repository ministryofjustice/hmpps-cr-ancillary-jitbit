output "jitbit" {
  value = {
    ...
    passive_autoscaling_group_name         = module.green.asg["autoscaling_group_name"]
    passive_aws_lb_target_group_name       = module.green.asg["aws_lb_target_group_name"]
    passive_aws_lb_target_group_arn_suffix = module.green.asg["aws_lb_target_group_arn_suffix"]
